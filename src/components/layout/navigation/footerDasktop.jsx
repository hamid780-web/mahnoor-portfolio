        ...
        <div className="flex items-center flex-col justify-center w-full">
          <div className="flex flex-col items-center justify-center w-full">
            <div className="flex items-center justify-between w-full pb-[42px]">
              ...
              <div className="flex xl:gap-10 gap-6 text-2xl">
                {footerItems
                  ...
                  .map((item, index) => (
                    <Link href="/" key={index} className="hover:text-primary">
                      {item.icon}{" "}
                    </Link>
                  ))}{" "}
              </div>
            ...
            <div className="border-t border-[#2B3D51] w-full flex items-center justify-between pt-[52px]">
              ...
              <div>
                <h1 className="font-poppins font-normal text-[28px] leading-[36px] tracking-0% text-primary">
                  Mahnoor
                </h1>
              </div>
              <div className="flex items-center justify-center xl:gap-10  gap-6 ">
                <Link
                  href="/"
                  className="hover:text-primary font-inter font-normal text-[14px] leading-[100%] tracking-0%"
                >
                  Terms of Service
                </Link>
                <Link
