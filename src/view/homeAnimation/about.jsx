        ...
        <div className="flex justify-between  w-full flex-col-reverse lg:flex-row gap-10 lg:gap-0">
          <div className="w-full flex  ">
            <div className="lg:max-w-[457px] w-full">
              <h1
                data-aos="fade-right"
                className="font-poppins font-semibold text-[23px] leading-[26px] sm:text-[30px] sm:leading-[48px] tracking-normal  text-primary pb-2.5"
              >
                About Me
              </h1>
              <p
                data-aos="fade-right"
                className="font-poppins font-medium  xl:text-[20px] text-[14px] leading-[20px] sm:text-[16px] sm:leading-6 xl:leading-[29px] tracking-normalfont-poppins  pb-[15px]"
              >
              ...
              <p
                data-aos="fade-right"
                className="font-poppins font-medium  pb-[20px] md:pb-[25px]  xl:pb-[37px] xl:text-[20px] text-[14px] leading-[20px] sm:text-[16px] sm:leading-6 xl:leading-[29px] tracking-normal"
              >
          ...
          <div className="w-full flex items-center justify-center relative">
            <div className=" w-full flex flex-col items-center justify-center  xl:gap-0 ">
              ...
              <div
                data-aos="zoom-out"
                className="absolute max-w-[140px] max-h-[140px] sm:max-w-[203px] sm:max-h-[203px] w-full h-full rounded-full bg-black flex items-center justify-center "
              >
