...
const Hero = () => {
    return (
        <div className='xl:pt-[176px] xl:pb-[100px] pb-8 pt-28 lg:h-screen w-full flex items-center justify-center relative'>
            <div className='main-cantainer'>
                <div className='flex flex-col-reverse lg:flex-row items-center gap-5 justify-between '>
                    <div className='flex items-center flex-col w-full '>
                        <div className='max-w-[657px] w-full'>
                            <h1 className='font-poppins font-semibold xl:text-[50px] xl:leading-[65px] lg:text-[36px] lg:leading-9 text-[23px] leading-[26px] sm:text-[28px] sm:leading-7 tracking-normal xl:pb-[15px] pb-2.5'>MERN Stack <span className='text-primary'>Developer</span></h1>
                ...
                <div className='absolute bottom-0 left-0 lg:flex hidden'><Image src='/images/hero-3.png' alt='logo' width={200} height={200} /></div>
            </div>
        </div>
    )
}
